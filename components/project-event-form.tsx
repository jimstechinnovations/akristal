...
import { createProjectEvent } from '@/app/actions/projects'
...
export function ProjectEventForm({ projectId }: { projectId: string }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Submitting event with media URLs:', mediaUrls)

      const result = await createProjectEvent(projectId, formDataObj)
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Add Project Event</CardTitle>
      </CardHeader>
      <CardContent>
